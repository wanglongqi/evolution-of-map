...
$$
\Delta\lambda_{max} \approx 0.4° \times \frac{\pi}{180} \approx 0.007 \text{ rad}
$$

$$
\cos\phi \approx \cos 1.3° \approx 0.9997
$$

$$
h_{max} \approx 1 + \frac{(0.007)^2 \times (0.9997)^2}{2} \approx 1 + 2.4 \times 10^{-5}
$$
...
$$
\begin{pmatrix} X_{SVY21A} \\ Y_{SVY21A} \\ Z_{SVY21A} \end{pmatrix} = 
\begin{pmatrix} T_x \\ T_y \\ T_z \end{pmatrix} + 
(1 + s) \cdot \mathbf{R} \cdot 
\begin{pmatrix} X_{SVY21} \\ Y_{SVY21} \\ Z_{SVY21} \end{pmatrix}
$$
